var app = (function () {
    ...
    /* src/Progress.svelte generated by Svelte v3.44.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progressbar");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "class", "progress_container");
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", button_class_value = `start ${/*isRunning*/ ctx[1] && "disabled"}`);
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*second_left*/ 1) set_data(t1, /*second_left*/ ctx[0]);
    			const progress_1_changes = {};
    			if (dirty & /*progress*/ 4) progress_1_changes.progress = /*progress*/ ctx[2];
    			progress_1.$set(progress_1_changes);

    			if (!current || dirty & /*isRunning*/ 2 && button_class_value !== (button_class_value = `start ${/*isRunning*/ ctx[1] && "disabled"}`)) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function startTimer() {
    		...
    		const timer = setInterval(
    			() => {
    				$$invalidate(0, second_left -= 1);

    				if (second_left === 0) {
    					clearInterval(timer);
    					$$invalidate(1, isRunning = false);
    					$$invalidate(0, second_left = total_time);
    				}
    			},
    			1000
    		);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*second_left*/ 1) {
    			$$invalidate(2, progress = (total_time - second_left) / total_time * 100);
    		}
    	};

    	return [second_left, isRunning, progress, startTimer];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="https://raw.githubusercontent.com/phptuts/fcc-handwashing/master/public/handwashing.gif" alt="handwashing"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t3 = space();
    			h3 = element("h3");
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protection/en/">Image Source</a>`;
